...
(1, 'Darell', 'Sample', '+62 882-7245-4854', 0, 'darellfawwas@gmail.com', '4744ddea876b11dcb1d169fadf494418');
...
(1, 1, 'Pembayaran Pajak', 'Jl.Bumi Manti 2 ', '2023-4-20 10:48:19', 3),
...
CREATE TABLE `users` (
  ...
  `password` text NOT NULL,
  `type` tinyint(1) NOT NULL DEFAULT 3 COMMENT '1=User,2=Admin,3=Staff'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 'admin', 'darell', '0192023a7bbd73250516f069df18b500', 1);
